...
public:
    ...
    {
        static CameraController instance; // 必要になるまでインスタンスを生成しない
        return instance;
    }
    ...
    bool GetIsCubeView() const { return isCubeView; }
    void SetIsCubeView(bool value) { isCubeView = value; }

    const int& GetCameraPointPosition() const { return cameraPointPosition; }
...
private:
    ...
    DirectX::XMFLOAT3 angle = { 0.0873f, 0, 0 };
